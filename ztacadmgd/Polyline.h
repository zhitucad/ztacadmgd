...
namespace ztAcadMgd {
	namespace DatabaseServices {
		...
		public ref class Polyline : public ztAcadMgd::DatabaseServices::Curve {
		...
		internal:
			Polyline (System::IntPtr unmanagedPointer, bool bAutoDelete) ;

			//- Returns the unmanaged ARX Object
			inline AcDbPolyline *GetImpObj () {
				return (static_cast<AcDbPolyline *>(UnmanagedObject.ToPointer ())) ;
			}
