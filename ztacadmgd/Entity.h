...
namespace ztmgd {
	namespace DatabaseServices {
		...
		[Autodesk::AutoCAD::Runtime::Wrapper("AcDbEntity")]
		public ref class Entity : public Autodesk::AutoCAD::DatabaseServices::DBObject {
		...
		internal:
			Entity (System::IntPtr unmanagedPointer, bool bAutoDelete) ;

			//- Returns the unmanaged ARX Object
			inline AcDbEntity *GetImpObj () {
				return (static_cast<AcDbEntity *>(UnmanagedObject.ToPointer ())) ;
			}
