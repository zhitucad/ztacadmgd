...
//-----------------------------------------------------------------------------
ztmgd::DatabaseServices::SymbolTable::SymbolTable () 
	: Autodesk::AutoCAD::DatabaseServices::DBObject ((System::IntPtr)new AcDbSymbolTable (), true)
{
}

//-----------------------------------------------------------------------------
ztmgd::DatabaseServices::SymbolTable::SymbolTable (System::IntPtr unmanagedPointer, bool bAutoDelete)
