...
//-----------------------------------------------------------------------------
ztmgd::DatabaseServices::SymbolTableRecord::SymbolTableRecord () 
	: Autodesk::AutoCAD::DatabaseServices::DBObject ((System::IntPtr)new AcDbSymbolTableRecord (), true)
{
}

//-----------------------------------------------------------------------------
ztmgd::DatabaseServices::SymbolTableRecord::SymbolTableRecord (System::IntPtr unmanagedPointer, bool bAutoDelete)
