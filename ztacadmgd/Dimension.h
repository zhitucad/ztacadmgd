...
namespace ztAcadMgd {
	namespace DatabaseServices {
		...
		/// БъзЂ
		/// </summary> 
		[Wrapper("AcDbDimension")]
		public ref class Dimension abstract : public Autodesk::AutoCAD::DatabaseServices::Entity {
		...
		internal:
			//Dimension (System::IntPtr unmanagedPointer, bool bAutoDelete) ;

			//- Returns the unmanaged ARX Object
			inline AcDbDimension *GetImpObj () {
				return (static_cast<AcDbDimension *>(UnmanagedObject.ToPointer ())) ;
			}
