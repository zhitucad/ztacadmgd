...
namespace ztmgd {
	namespace DatabaseServices {
		...
		[Autodesk::AutoCAD::Runtime::Wrapper("AcDbSymbolTableRecord")]
		public ref class SymbolTableRecord : public Autodesk::AutoCAD::DatabaseServices::DBObject {
		...
		internal:
			SymbolTableRecord (System::IntPtr unmanagedPointer, bool bAutoDelete) ;

			//- Returns the unmanaged ARX Object
			inline AcDbSymbolTableRecord *GetImpObj () {
				return (static_cast<AcDbSymbolTableRecord *>(UnmanagedObject.ToPointer ())) ;
			}
